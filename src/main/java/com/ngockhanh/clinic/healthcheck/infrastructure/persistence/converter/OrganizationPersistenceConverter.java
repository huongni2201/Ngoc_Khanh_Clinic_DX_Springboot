...
public final class OrganizationPersistenceConverter {
    public Organization toDomain(OrganizationRecord record) {
        ...
        return Organization.restore(record.id(), record.organizationCode(), record.organizationName(), record.taxCode(),
    ...
    public OrganizationRecord toRecord(Organization organization) {
        return new OrganizationRecord(organization.id(), organization.code(), organization.name(), organization.taxCode(),
