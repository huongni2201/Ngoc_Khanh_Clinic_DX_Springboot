...
class PersistenceRecordContractTest {
    ...
    private static Stream<Arguments> latestSchemaRecords() {
        return Stream.of(
                ...
                Arguments.of("com.ngockhanh.clinic.encounter.infrastructure.persistence.record.JourneyRecord", List.of("id", "encounter_id", "current_stage", "current_department_id", "current_room_id", "stage_entered_at", "updated_at", "row_version")),
                Arguments.of("com.ngockhanh.clinic.encounter.infrastructure.persistence.record.JourneyEventRecord", List.of("id", "journey_id", "from_stage", "to_stage", "department_id", "room_id", "reason", "occurred_at", "actor_user_id")),
