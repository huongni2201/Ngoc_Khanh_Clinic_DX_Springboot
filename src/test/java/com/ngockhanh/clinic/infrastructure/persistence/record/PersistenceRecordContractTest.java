...
class PersistenceRecordContractTest {
    ...
    private static Stream<Arguments> latestSchemaRecords() {
        return Stream.of(
                Arguments.of("com.ngockhanh.clinic.patient.infrastructure.persistence.record.PatientRecord", List.of("id", "patient_code", "cccd", "full_name", "full_name_normalized", "date_of_birth", "sex", "phone", "email", "address", "ward_code", "province_code", "occupation", "note", "status", "created_at", "updated_at", "row_version")),
                ...
                Arguments.of("com.ngockhanh.clinic.document.infrastructure.persistence.record.DocumentTemplateRecord", List.of("id", "template_code", "template_name", "template_type", "barcode_policy", "is_master_health_check_form", "is_active", "created_at", "updated_at")),
                ...
                Arguments.of("com.ngockhanh.clinic.clinical.infrastructure.persistence.record.OrderRoundRecord", List.of("id", "encounter_id", "health_check_record_id", "round_number", "source_type", "status", "ordered_by_staff_id", "created_by_user_id", "ordered_at")),
                ...
                Arguments.of("com.ngockhanh.clinic.healthcheck.infrastructure.persistence.record.CompanyEmployeeRecord", List.of("id", "company_id", "patient_id", "employee_code", "cccd", "full_name", "date_of_birth", "sex", "department_name", "job_title", "occupation", "status", "created_at", "updated_at")),
                Arguments.of("com.ngockhanh.clinic.healthcheck.infrastructure.persistence.record.HealthCheckBatchRecord", List.of("id", "company_id", "batch_code", "batch_name", "start_date", "end_date", "reason", "payer_type", "examination_site_type", "examination_site_name", "examination_site_address", "master_template_version_id", "status", "finalized_at", "closed_at", "created_by_user_id", "created_at", "updated_at")),
                Arguments.of("com.ngockhanh.clinic.healthcheck.infrastructure.persistence.record.HealthCheckBatchServiceRecord", List.of("id", "health_check_batch_id", "service_id", "document_template_version_id", "service_code_snapshot", "service_name_snapshot", "base_price_snapshot", "negotiated_unit_price", "currency", "display_order", "status", "created_at", "updated_at")),
                Arguments.of("com.ngockhanh.clinic.healthcheck.infrastructure.persistence.record.HealthCheckBatchEmployeeRecord", List.of("id", "health_check_batch_id", "company_employee_id", "employee_code_snapshot", "department_snapshot", "job_title_snapshot", "occupation_snapshot", "administrative_snapshot_json", "status", "created_at")),
                Arguments.of("com.ngockhanh.clinic.healthcheck.infrastructure.persistence.record.HealthCheckRecord", List.of("id", "shs_code", "source_type", "patient_id", "health_check_batch_employee_id", "encounter_id", "master_template_version_id", "full_name_snapshot", "date_of_birth_snapshot", "sex_snapshot", "cccd_snapshot", "cccd_issue_date_snapshot", "cccd_issue_place_snapshot", "ethnicity_snapshot", "subject_type_snapshot", "payer_source_snapshot", "blood_group_snapshot", "phone_snapshot", "province_snapshot", "ward_snapshot", "address_detail_snapshot", "occupation_snapshot", "workplace_or_school_snapshot", "health_check_reason_snapshot", "planned_examination_date", "actual_examination_date", "status", "replaces_health_check_record_id", "created_at", "completed_at", "canceled_at", "row_version")),
                Arguments.of("com.ngockhanh.clinic.healthcheck.infrastructure.persistence.record.HealthCheckBatchEmployeeServiceRecord", List.of("id", "health_check_batch_employee_id", "health_check_batch_service_id", "service_request_id", "billable", "unit_price_snapshot", "created_at", "updated_at")),
                Arguments.of("com.ngockhanh.clinic.healthcheck.infrastructure.persistence.record.HealthCheckImportJobRecord", List.of("id", "health_check_batch_id", "import_type", "source_file_attachment_id", "status", "column_mapping_json", "total_rows", "valid_rows", "warning_rows", "error_rows", "created_by_user_id", "confirmed_by_user_id", "created_at", "confirmed_at")),
                Arguments.of("com.ngockhanh.clinic.healthcheck.infrastructure.persistence.record.HealthCheckImportRowRecord", List.of("id", "health_check_import_job_id", "row_number", "employee_code_snapshot", "cccd_snapshot", "service_code_snapshot", "validation_status", "error_codes_json", "normalized_payload_json", "resolved_patient_id", "resolved_company_employee_id", "resolved_batch_employee_id", "resolved_batch_service_id", "resolved_service_request_id")),
                ...
                Arguments.of("com.ngockhanh.clinic.diagnostics.infrastructure.persistence.record.LabResultRecord", List.of("id", "service_request_id", "specimen_id", "version_number", "status", "supersedes_lab_result_id", "result_source", "verified_by_staff_id", "verified_at", "finalized_at", "created_at", "raw_message_reference")),
                ...
                Arguments.of("com.ngockhanh.clinic.shared.infrastructure.persistence.record.AuditLogRecord", List.of("id", "occurred_at", "actor_user_id", "action", "entity_type", "entity_id", "patient_id", "encounter_id", "health_check_record_id", "correlation_id", "reason", "before_json", "after_json", "ip_address", "user_agent")),
